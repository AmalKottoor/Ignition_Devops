...
echo "     git remote add origin git@ssh.dev.azure.com:v3/Wilms-ICT/poc_ignition_8.3/poc_ignition_8.3"
echo "     git push -u origin main"
echo ""
echo "  3. Follow AZURE_DEVOPS_SETUP.md to complete CI/CD configuration"
echo ""
